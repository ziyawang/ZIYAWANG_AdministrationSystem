                ...
                <div class="widget-content nopadding">
                    ...
                    @foreach($datas as $data)
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="investType" id="investType" value="{{$data->InvestType}}"
                                       readonly/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <label class="control-label">预期回报</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls  span3">
                                <div><img id="PictureDes1" alt=""
                                       ...
                                       <span><a href="{{'Http://images.ziyawang.com'.$data->PictureDes1}}"><i
                                ...
                                <div><img id="PictureDes2" alt=""
                                        ...
                                        <span><a href="{{'Http://images.ziyawang.com'.$data->PictureDes2}}"><i
                                ...
                                <div><img id="PictureDes3" alt=""
                                          @if(!empty($data->PictureDes3))  src="{{'Http://images.ziyawang.com'.$data->PictureDes3}}" @endif/>
                                            <span><a href="{{'Http://images.ziyawang.com'.$data->PictureDes3}}"><i
