                ...
                <div class="widget-content nopadding">
                    ...
                    @foreach($datas as $data)
                      ...
                      {{--  <div class="control-group">
                        ...
                        @if(!empty($data->BuildArea))
                            <div class="control-group">
                                <label class="control-label">建筑面积</label>
                                <div class="controls">
                                    <input type="text" name="buildArea" id="buildArea" value="{{$data->BuildArea}}" />
                                </div>
                            </div>
                        @endif
                        @if(!empty($data->FloorRatio))
                            <div class="control-group">
                                <label class="control-label">容积率</label>
                                <div class="controls">
                                    <input type="text" name="floorRatio" id="floorRatio" value="{{$data->FloorRatio}}" />
                                </div>
                            </div>
                        @endif
                      {{--  <div class="control-group">
