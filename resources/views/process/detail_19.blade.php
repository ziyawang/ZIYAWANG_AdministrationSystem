            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls " >
                            <input type="text" name="DebteeLocation" id="DebteeLocation" value="{{$data->DebteeLocation}}" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">是否有担保</label>
                        <div class="controls">
                            <input type="radio" name="Guaranty"  value="是" @if($data->Guaranty=="是") checked="checked" @endif/>是
                            <input type="radio" name="Guaranty"  value="否"  @if($data->Guaranty=="否") checked="checked" @endif />否
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="radio" name="Connect"  value="是" @if($data->Connect=="是") checked="checked" @endif/>是
                            <input type="radio" name="Connect"   value="否"  @if($data->Connect=="否") checked="checked" @endif />否
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">债务人是否有偿还能力</label>
                        <div class="controls">
                            <input type="radio" name="Pay"  value="是" @if($data->Pay=="是") checked="checked" @endif/>是
                            <input type="radio" name="Pay"   value="否"  @if($data->Pay=="否") checked="checked" @endif />否
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">相关凭证是否齐全</label>
                        <div class="controls">
                            <input type="radio" name="Credentials"  value="是" @if($data->Credentials=="是") checked="checked" @endif/>是
                            <input type="radio" name="Credentials"   value="否"  @if($data->Credentials=="否") checked="checked" @endif />否
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label checkState">项目亮点</label>
                        <div class="controls newsType">
                            <input type="checkbox" name="ProLabel[]"  value="佣金比例高 "   @if(in_array("佣金比例高",$proLabels)) checked="checked" @endif/>佣金比例高
