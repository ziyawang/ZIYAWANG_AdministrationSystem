            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" name="Month" id="Month" value=""/>月
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">诉讼-佣金比例</label>
                        <div class="controls">
                            <input type="text" name="Law" id="Law" value=""/>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">非诉催收-佣金比例</label>
                        <div class="controls">
                            <input type="text" name="UnLaw" id="UnLaw" value=""/>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls " >
                            <input type="text" name="DebteeLocation" id="DebteeLocation" value="" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">是否有担保</label>
                        <div class="controls">
                            <input type="radio" name="Guaranty" value="是" />是
                            <input type="radio" name="Guaranty"   value="否"/>否
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="radio" name="Connect"  value="是" />是
                                <input type="radio" name="Connect"   value="否"  />否
                            </div>
                        </div>
                    <div class="control-group">
                            <label class="control-label">债务人是否有偿还能力</label>
                            <div class="controls">
                                <input type="radio" name="Pay" value="是" />是
                    ...
                    <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="radio" name="Credentials"  value="是" />是
                                <input type="radio" name="Credentials"  value="否"  />否
                            </div>
                        </div>
                    <div class="control-group">
                        <label class="control-label checkState">项目亮点</label>
                        <div class="controls newsType">
                            <input type="checkbox" name="ProLabel[]"  value="佣金比例高 "  />佣金比例高
                            <input type="checkbox" name="ProLabel[]"  value="法律关系明确"  />法律关系明确
                        </div>
                    </div>
                    <div class="control-group">
