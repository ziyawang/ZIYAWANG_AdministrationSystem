                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls selectBox" >
                            ...
                            <option value="正常运营" selected="selected">正常运营</option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="radio" name="Guaranty" id="Guaranty" value="有"/>有
                            <input type="radio" name="Guaranty"  id="Guaranty" value="无"  />无
                        </div>
                    </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="radio" name="State" id="State" value="已诉" />已诉
                                <input type="radio" name="State"  id="State" value="未诉"   />未诉
                                <input type="radio" name="State"  id="State" value="已判决"  />已判决
                            </div>
                        </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls newsType">
                            <input type="checkbox" name="ProLabel[]" value="债务方有偿还能力"  />佣金比例高
