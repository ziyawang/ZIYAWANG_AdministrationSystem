                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="control-group" id="AssetType">
                        ...
                        <div class="controls">
                            ...
                            @endif
                            @if($data->TypeID=="20")
                                <input type="radio" name="AssetType"    value="20" checked="checked"  />房产
                            @endif
                            @if($data->TypeID=="22")
                                <input type="radio" name="AssetType"    value="22"  checked="checked" />汽车
                            @endif
                        </div>
                    </div>
                    @if( $data->TypeID=="22")
                    ...
                    @if($data->TypeID!="22")
                        <div class="control-group" id="Area">
                            ...
                            <div class="controls">
                                <input type="number" name="Area"  value="{{$data->Area}}"/>
                            </div>
                        </div>
                    @endif
                    @if($data->TypeID!="22")
                        <div class="control-group"  id="Nature">
                            ...
                            <div class="controls selectBox" >
                                <select  name="Nature"/>
                                <option value="工业" @if($data->Nature=="工业") selected="selected" @endif>工业</option>
                                <option value="商业" @if($data->Nature=="商业") selected="selected" @endif>商业</option>
                                <option value="住宅" @if($data->Nature=="住宅") selected="selected" @endif>住宅</option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls " >
                            <input type="text" name="Year" class="shortTime" value="{{$data->Year}}"/>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls " >
                            <input type="text" name="Court" id="Court" value="{{$data->Court}}"  />
                        </div>
                    </div>
                    <div class="control-group">
