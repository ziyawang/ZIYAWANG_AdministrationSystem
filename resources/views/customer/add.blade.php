            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    <div class="control-group" id="CustomerNeed" >
                        ...
                        <div class="controls"  >
                            <div>
                                <input type="text" name="CustomerNeed[]"  value=""   /><span id="add" class='customerNeed'>+</span>
                            </div>
                        </div>
                    </div>
                    <script>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls ec_right upload">
                            ...
                            <div class="fileinput-button">
                                <!-- The file input field used as target for the file upload widget -->
                                <input id="list_upload" type="file" name="files[]" data-url="http://admin.ziyawang.com/public/upload"  >
                            </div>
                        </div>
                    </div>
