                    ...
                    <?php foreach($datas as $data): ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls selectBox" >
                                ...
                                <option value="工业" <?php if($data->Nature=="工业"): ?> selected="selected" <?php endif; ?>>工业</option>
                                <option value="商业" <?php if($data->Nature=="商业"): ?> selected="selected" <?php endif; ?>>商业</option>
                                <option value="住宅" <?php if($data->Nature=="住宅"): ?> selected="selected" <?php endif; ?>>住宅</option>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls " >
                                <input type="text" name="Year" id="Year" value="<?php echo e($data->Year); ?>" readonly  />
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls selectBox" >
                                ...
                                <option value="一拍" <?php if($data->State=="一拍"): ?> selected="selected" <?php endif; ?>>一拍</option>
                                <option value="二拍" <?php if($data->State=="二拍"): ?> selected="selected" <?php endif; ?>>二拍</option>
                                <option value="三拍" <?php if($data->State=="三拍"): ?> selected="selected" <?php endif; ?>>三拍</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls " >
                                <input type="text" name="Court" id="Court" value="<?php echo e($data->Court); ?>" readonly  />
                            </div>
                        </div>
                        <div class="control-group">
