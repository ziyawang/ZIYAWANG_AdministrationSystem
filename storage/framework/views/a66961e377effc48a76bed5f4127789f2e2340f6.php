        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form method="post" action="<?php echo e(asset('video/add')); ?>" class="form-horizontal" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls newsType">
                            <?php foreach($datas as $data): ?>
                                <input type="checkbox" name="type[]" value="<?php echo e($data->id); ?>" /><?php echo e($data->TypeName); ?>
