...
<div id="breadcrumb" style="position:relative">
    <a href="<?php echo e(asset('data/index')); ?>" title="数据分析" class="tip-bottom"><i class="icon-home"></i>信息统计</a>
...
<div style="height:80px;margin-left:40px;">
    <div style="float: right">
        ...
        <?php else: ?>
            ...
            <input type="radio" name="choose" value="1"  checked="checked" />时间区间<input type="text" name="shortTime" id="shortTime" value="<?php echo e($shortTime); ?>" style="width:100px"/>&nbsp&nbsp&nbsp&nbsp~&nbsp&nbsp&nbsp&nbsp <input type="text" name="longTime"  id="longTime" value="<?php echo e($longTime); ?>"  style="width:100px"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <?php endif; ?>
            地区<select  name="province" id="province"/>
            <option   value="全国" <?php if(!empty($province) && $province=="北京"): ?> selected="selected" <?php endif; ?>>--全国--</option>
...
<script>
    $(function () {
        $.ajax({
            url:"<?php echo e(asset('count/mapCounts')); ?>",
            data:{data:1},
            type:"post",
            dataType:"json",
...
<script type="text/javascript">
   ...
   $(function(){
       ...
       var value=$("input[type='radio']:checked").val();
       $.ajax({
           url:"<?php echo e(asset('count/numMoneyCount')); ?>",
