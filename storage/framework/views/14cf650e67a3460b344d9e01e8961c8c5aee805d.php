                ...
                <div class="widget-content nopadding">
                    ...
                    <?php foreach($datas as $data): ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls " >
                                <input type="text" name="DebteeLocation" id="DebteeLocation" value="<?php echo e($data->DebteeLocation); ?>" readonly  />
                            </div>
                        </div>
                        <?php if(!empty($data->Guaranty)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="radio" name="Guaranty" id="Guaranty" value="是" <?php if($data->Guaranty=="是"): ?> checked="checked" <?php endif; ?>/>是
                                    <input type="radio" name="Guaranty"  id="Guaranty" value="否"  <?php if($data->Guaranty=="否"): ?> checked="checked" <?php endif; ?> />否
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <?php if(!empty($data->Connect)): ?>
                            <div class="control-group">
                                <label class="control-label">债务人是否失联</label>
                                <div class="controls">
                                    <input type="radio" name="Connect" id="Connect" value="是" <?php if($data->Connect=="是"): ?> checked="checked" <?php endif; ?>/>是
                                    <input type="radio" name="Connect"  id="Connect" value="否"  <?php if($data->Connect=="否"): ?> checked="checked" <?php endif; ?> />否
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->Pay)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="radio" name="Pay" id="Pay" value="是" <?php if($data->Pay=="是"): ?> checked="checked" <?php endif; ?>/>是
                                    <input type="radio" name="Pay"  id="Pay" value="否"  <?php if($data->Pay=="否"): ?> checked="checked" <?php endif; ?> />否
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->Credentials)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="radio" name="Credentials" id="Credentials" value="是" <?php if($data->Credentials=="是"): ?> checked="checked" <?php endif; ?>/>是
                                    <input type="radio" name="Credentials"  id="Credentials" value="否"  <?php if($data->Credentials=="否"): ?> checked="checked" <?php endif; ?> />否
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->ProLabel)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls newsType">
                                    <input type="checkbox" name="ProLabel[]" id="ProLabel" value="佣金比例高 "   <?php if(in_array("佣金比例高",$proLabels)): ?> checked="checked" <?php endif; ?>/>佣金比例高
