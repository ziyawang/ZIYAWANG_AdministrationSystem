                    ...
                    <?php foreach($datas as $data): ?>
                        ...
                        <?php if(!empty($data->Type)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="radio" name="Type" id="Type" value="抵押" <?php if($data->Type=="抵押"): ?> checked="checked" <?php endif; ?>/>抵押
                                    <input type="radio" name="Type"  id="Type" value="质押"  <?php if($data->Type=="质押"): ?> checked="checked" <?php endif; ?> />质押
                                    <input type="radio" name="Type"  id="Type" value="担保人"  <?php if($data->Type=="担保人"): ?> checked="checked" <?php endif; ?> />担保人
                                    <input type="radio" name="Type"  id="Type" value="其他"  <?php if($data->Type=="其他"): ?> checked="checked" <?php endif; ?> />其他
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="control-group">
                                ...
                                <div class="controls newsType">
                                    <input type="checkbox" name="ProLabel[]" id="ProLabel" value="抵押物足值"   <?php if(in_array("抵押物足值",$proLabels)): ?> checked="checked" <?php endif; ?>/>抵押物足值
                                    <input type="checkbox" name="ProLabel[]"  id="ProLabel" value="回报率高"  <?php if(in_array("回报率高",$proLabels)): ?> checked="checked" <?php endif; ?> />回报率高
                                </div>
                            </div>
                        <?php endif; ?>
                        <div class="control-group">
