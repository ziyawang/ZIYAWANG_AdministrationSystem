<?php $__env->startSection('content'); ?>
    ...
    <div class="widget-content nopadding">
        <form class="form-horizontal" method="post" action="<?php echo e(asset('refuse/index')); ?>" name="basic_validate"  novalidate="novalidate" />
            ...
            <table class="table table-bordered table-striped">
                ...
                <?php foreach($datas as $data): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo e(url('refuse/detail/'.$data->RushProID)); ?>">查看</a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
