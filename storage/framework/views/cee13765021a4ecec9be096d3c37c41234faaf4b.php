                    ...
                    <?php foreach($datas as $data): ?>
                        ...
                        <?php if(!empty($data->Identity)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls selectBox" >
                                    ...
                                    <option value="项目持有者" <?php if($data->Identity=="债权人"): ?> selected="selected" <?php endif; ?>>债权人</option>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls selectBox" >
                                ...
                                <option value="货款" <?php if($data->AssetType=="货款"): ?> selected="selected" <?php endif; ?>>货款</option>
                                <option value="工程款" <?php if($data->AssetType=="工程款"): ?> selected="selected" <?php endif; ?>>工程款</option>
                                <option value="违约金" <?php if($data->AssetType=="违约金"): ?> selected="selected" <?php endif; ?>>违约金</option>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" name="Month" id="Month" value="<?php echo e($data->Month); ?>"/>月
                            </div>
                        </div>
                        <?php if(!empty($data->Law)): ?>
                            <div class="control-group">
                                <label class="control-label">诉讼-佣金比例</label>
                                <div class="controls">
                                    <input type="text" name="Law" id="Law" value="<?php echo e($data->Law); ?>"/>
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->UnLaw)): ?>
                            <div class="control-group">
                                <label class="control-label">非诉催收-佣金比例</label>
                                <div class="controls">
                                    <input type="text" name="UnLaw" id="UnLaw" value="<?php echo e($data->UnLaw); ?>"/>
                                </div>
                            </div>
                        <?php endif; ?>
                        <div class="control-group">
                            ...
                            <div class="controls " >
                                <input type="text" name="ProArea" id="ProArea" value="<?php echo e($data->ProArea); ?>" readonly  />
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls selectBox" >
                                ...
                                <option value="国企" <?php if($data->Nature=="国企"): ?> selected="selected" <?php endif; ?>>国企</option>
                                <option value="央企" <?php if($data->Nature=="央企"): ?> selected="selected" <?php endif; ?>>央企</option>
                                <option value="民营" <?php if($data->Nature=="民营"): ?> selected="selected" <?php endif; ?>>民营</option>
                                <option value="其他" <?php if($data->Nature=="其他"): ?> selected="selected" <?php endif; ?>>其他</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls selectBox" >
                                ...
                                <option value="正常运营" <?php if($data->Status=="正常运营"): ?> selected="selected" <?php endif; ?>>正常运营</option>
                                <option value="濒临倒闭" <?php if($data->Status=="濒临倒闭"): ?> selected="selected" <?php endif; ?>>濒临倒闭</option>
                                <option value="倒闭" <?php if($data->Status=="倒闭"): ?> selected="selected" <?php endif; ?>>倒闭</option>
                                <option value="其他" <?php if($data->Status=="其他"): ?> selected="selected" <?php endif; ?>>其他</option>
                                </select>
                            </div>
                        </div>
                        <?php if(!empty($data->Guaranty)): ?>
                            <div class="control-group">
                                <label class="control-label">债权相关凭证</label>
                                <div class="controls">
                                    <input type="radio" name="Guaranty" id="Guaranty" value="有" <?php if($data->Guaranty=="有"): ?> checked="checked" <?php endif; ?>/>有
                                    <input type="radio" name="Guaranty"  id="Guaranty" value="无"  <?php if($data->Guaranty=="无"): ?> checked="checked" <?php endif; ?> />无
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->State)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="radio" name="State" id="State" value="已诉" <?php if($data->State=="已诉"): ?> checked="checked" <?php endif; ?>/>已诉
                                    <input type="radio" name="State"  id="State" value="未诉"  <?php if($data->State=="未诉"): ?> checked="checked" <?php endif; ?> />未诉
                                    <input type="radio" name="State"  id="State" value="已判决"  <?php if($data->State=="已判决"): ?> checked="checked" <?php endif; ?> />已判决
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->Industry)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <option value="IT|通信|电子|互联网" <?php if($data->Industry=="IT|通信|电子|互联网"): ?> selected="selected" <?php endif; ?>>IT|通信|电子|互联网</option>
                                    <option value="金融业" <?php if($data->Industry=="金融业"): ?> selected="selected" <?php endif; ?>>金融业</option>
                                    <option value="房地产|建筑业" <?php if($data->Industry=="房地产|建筑业"): ?> selected="selected" <?php endif; ?>>房地产|建筑业</option>
                                    <option value="商业服务" <?php if($data->Industry=="商业服务"): ?> selected="selected" <?php endif; ?>>商业服务</option>
                                    <option value="贸易|批发|零售|租赁业" <?php if($data->Industry=="贸易|批发|零售|租赁业"): ?> selected="selected" <?php endif; ?>>贸易|批发|零售|租赁业</option>
                                    <option value="文体教育|工艺美术" <?php if($data->Industry=="文体教育|工艺美术"): ?> selected="selected" <?php endif; ?>>文体教育|工艺美术</option>
                                    <option value="生产|加工|制造" <?php if($data->Industry=="生产|加工|制造"): ?> selected="selected" <?php endif; ?>>生产|加工|制造</option>
                                    <option value="交通|运输|物流|仓储" <?php if($data->Industry=="交通|运输|物流|仓储"): ?> selected="selected" <?php endif; ?>>交通|运输|物流|仓储</option>
                                    <option value="服务业" <?php if($data->Industry=="服务业"): ?> selected="selected" <?php endif; ?>>服务业</option>
                                    <option value="文化|传媒|娱乐|体育" <?php if($data->Industry=="文化|传媒|娱乐|体育"): ?> selected="selected" <?php endif; ?>>文化|传媒|娱乐|体育</option>
                                    <option value="能源|矿产|环保" <?php if($data->Industry=="能源|矿产|环保"): ?> selected="selected" <?php endif; ?>>能源|矿产|环保</option>
                                    <option value="政府|非盈利机构" <?php if($data->Industry=="政府|非盈利机构"): ?> selected="selected" <?php endif; ?>>政府|非盈利机构</option>
                                    <option value="农|林|牧|渔|其他" <?php if($data->Industry=="农|林|牧|渔|其他"): ?> selected="selected" <?php endif; ?>>农|林|牧|渔|其他</option>
                                    </select>
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->ProLabel)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls newsType">
                                    <input type="checkbox" name="ProLabel[]" id="ProLabel" value="债务方有偿还能力"   <?php if(in_array("债务方有偿还能力",$proLabels)): ?> checked="checked" <?php endif; ?>/>佣金比例高
                                    <input type="checkbox" name="ProLabel[]"  id="ProLabel" value="法律关系明确"  <?php if(in_array("法律关系明确",$proLabels)): ?> checked="checked" <?php endif; ?> />法律关系明确
                                </div>
                            </div>
                        <?php endif; ?>
                        <div class="control-group">
