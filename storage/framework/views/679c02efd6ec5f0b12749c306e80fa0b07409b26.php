                ...
                <div class="widget-content nopadding">
                    ...
                    <?php foreach($datas as $data): ?>
                        ...
                        <?php if($data->AssetType!="股权融资"): ?>
                            <div class="control-group">
                                ...
                                <div class="controls selectBox" >
                                    ...
                                    <option value="质押" <?php if($data->AssetType=="质押"): ?> selected="selected" <?php endif; ?>>质押</option>
                                    <option value="租赁" <?php if($data->AssetType=="租赁"): ?> selected="selected" <?php endif; ?>>租赁</option>
                                    <option value="过桥" <?php if($data->AssetType=="过桥"): ?> selected="selected" <?php endif; ?>>过桥</option>
                                    <option value="信用" <?php if($data->AssetType=="信用"): ?> selected="selected" <?php endif; ?>>信用</option>
                                    <option value="股权" <?php if($data->AssetType=="股权"): ?> selected="selected" <?php endif; ?>>股权</option>
                                    <option value="担保" <?php if($data->AssetType=="担保"): ?> selected="selected" <?php endif; ?>>担保</option>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="Rate" id="Rate" value="<?php echo e($data->Rate); ?>"/>
                            </div>
                        </div>
                        <?php if(!empty($data->Status)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="radio" name="Status" id="Status" value="初创期" <?php if($data->Status=="初创期"): ?> checked="checked" <?php endif; ?>/>初创期
                                    <input type="radio" name="Status"  id="Status" value="成长期"  <?php if($data->Status=="成长期"): ?> checked="checked" <?php endif; ?> />成长期
                                    <input type="radio" name="Status"  id="Status" value="其他"  <?php if($data->Status=="其他"): ?> checked="checked" <?php endif; ?> />其他
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->Belong)): ?>
                            <div class="control-group">
                                <label class="control-label checkState">所属行业</label>
                                <div class="controls selectBox" >
                                    <select  name="Belong" id="Belong"/>
                                    <option value="IT|通信|电子|互联网" <?php if($data->Belong=="IT|通信|电子|互联网"): ?> selected="selected" <?php endif; ?>>IT|通信|电子|互联网</option>
                                    <option value="金融业" <?php if($data->Belong=="金融业"): ?> selected="selected" <?php endif; ?>>金融业</option>
                                    <option value="房地产|建筑业" <?php if($data->Belong=="房地产|建筑业"): ?> selected="selected" <?php endif; ?>>房地产|建筑业</option>
                                    <option value="商业服务" <?php if($data->Belong=="商业服务"): ?> selected="selected" <?php endif; ?>>商业服务</option>
                                    <option value="贸易|批发|零售|租赁业" <?php if($data->Belong=="贸易|批发|零售|租赁业"): ?> selected="selected" <?php endif; ?>>贸易|批发|零售|租赁业</option>
                                    <option value="文体教育|工艺美术" <?php if($data->Belong=="文体教育|工艺美术"): ?> selected="selected" <?php endif; ?>>文体教育|工艺美术</option>
                                    <option value="生产|加工|制造" <?php if($data->Belong=="生产|加工|制造"): ?> selected="selected" <?php endif; ?>>生产|加工|制造</option>
                                    <option value="交通|运输|物流|仓储" <?php if($data->Belong=="交通|运输|物流|仓储"): ?> selected="selected" <?php endif; ?>>交通|运输|物流|仓储</option>
                                    <option value="服务业" <?php if($data->Belong=="服务业"): ?> selected="selected" <?php endif; ?>>服务业</option>
                                    <option value="文化|传媒|娱乐|体育" <?php if($data->Belong=="文化|传媒|娱乐|体育"): ?> selected="selected" <?php endif; ?>>文化|传媒|娱乐|体育</option>
                                    <option value="能源|矿产|环保" <?php if($data->Belong=="能源|矿产|环保"): ?> selected="selected" <?php endif; ?>>能源|矿产|环保</option>
                                    <option value="政府|非盈利机构" <?php if($data->Belong=="政府|非盈利机构"): ?> selected="selected" <?php endif; ?>>政府|非盈利机构</option>
                                    <option value="农|林|牧|渔|其他" <?php if($data->Belong=="农|林|牧|渔|其他"): ?> selected="selected" <?php endif; ?>>农|林|牧|渔|其他</option>
                                    </select>
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->Usefor)): ?>
                            <div class="control-group">
                                <label class="control-label checkState">资金用途</label>
                                <div class="controls selectBox" >
                                    <select  name="Usefor" id="Usefor"/>
                                    <option value="经营" <?php if($data->Usefor=="经营"): ?> selected="selected" <?php endif; ?>>经营</option>
                                    <option value="扩张" <?php if($data->Usefor=="扩张"): ?> selected="selected" <?php endif; ?>>扩张</option>
                        ...
                        <?php if(!empty($data->ProLabel)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls newsType">
                                    <input type="checkbox" name="ProLabel[]" id="ProLabel" value="大股东兜底"   <?php if(in_array("大股东兜底",$proLabels)): ?> checked="checked" <?php endif; ?>/>大股东兜底
                                    <input type="checkbox" name="ProLabel[]"  id="ProLabel" value="热门项目"  <?php if(in_array("热门项目",$proLabels)): ?> checked="checked" <?php endif; ?> />热门项目
                                    <input type="checkbox" name="ProLabel[]"  id="ProLabel" value="成熟市场"  <?php if(in_array("成熟市场",$proLabels)): ?> checked="checked" <?php endif; ?> />成熟市场
                                </div>
                            </div>
                        <?php endif; ?>
                        <div class="control-group">
