...
<style>
    ...
    <div id="breadcrumb">
        <a href="<?php echo e(url('operate/index')); ?>" title="轮播图" class="tip-bottom"><i class="icon-home"></i> 轮播图</a>
        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form method="post" action="<?php echo e(asset('operate/save')); ?>" class="form-horizontal" />
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $("#file_upload").uploadifive({
                ...
                'fileSizeLimit':1024,
                'uploadScript'     :"<?php echo e(url('/operate/upload')); ?>",
