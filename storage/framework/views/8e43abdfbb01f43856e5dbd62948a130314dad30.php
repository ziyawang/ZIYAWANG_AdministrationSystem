...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav btn-group">
        <li class="btn btn-inverse"><a title="" href="<?php echo e(url("login/index")); ?>"><i class="icon icon-share-alt"></i> <span
                                        ...
                                        <?php foreach($Auths as $Auth): ?>
                                            <?php if($Auth->PID==$pAuth->Auth_ID): ?>
                                                <?php if($Auth->Auth_ID==$lds_Id): ?>
                                                    <li class="active" onclick='rePath(this)' id="<?php echo e($Auth->Auth_ID); ?>"><a
                                                                href="#"><?php echo e($Auth->AuthName); ?></a></li>
                                                <?php else: ?>

                                                    <li onclick="rePath(this)" id="<?php echo e($Auth->Auth_ID); ?>"><a
                                                                href="#"><?php echo e($Auth->AuthName); ?></a></li>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
