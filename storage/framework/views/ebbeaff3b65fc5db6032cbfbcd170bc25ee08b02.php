<?php $__env->startSection('content'); ?>
    ...
    <div id="breadcrumb">
        <a href="<?php echo e(asset('publish/index')); ?>" title="用户注册" class="tip-bottom"><i class="icon-home"></i>用户注册</a>
  ...
  <div class="widget-content nopadding">
        ...
        <table  class="table table-bordered table-striped publishTable">
            ...
            <td class="tdTime" style="float: right">
                <div class="control-group ">
                    ...
                    <div class="controls" >
                        <input type="text" name="shortTime"  id="shortTime" value="<?php echo e($shortTime); ?>"  style="width:100px"/>&nbsp&nbsp~&nbsp&nbsp<input type="text" name="longTime"  id="longTime" value="<?php echo e($longTime); ?>"  style="width:100px"/>
                    </div>
                </div>
            </td>
            <td  style="float: right;width: 30%">
                <div class="control-group">
                    ...
                    <div class="controls" >
                        ...
                        <option value="全部" <?php if($channel=="全部"): ?> selected="selected" <?php endif; ?>>全部</option>
                        <option value="电脑" <?php if($channel=="电脑"): ?> selected="selected" <?php endif; ?>>电脑</option>
                        <option value="安卓" <?php if($channel=="安卓"): ?> selected="selected" <?php endif; ?>>安卓</option>
                        <option value="苹果" <?php if($channel=="苹果"): ?> selected="selected" <?php endif; ?>>苹果</option>
                        </select>
                    </div>
                </div>
            </td>
    ...
    <script>
        ...
        <div class="clearfix">
            <input type="hidden" id="channel" name="channel" value="<?php echo e($channel); ?>" >
        ...
        <script>
            ...
            function register(longTime,shortTime,channel){
                $.ajax({
                    url: "<?php echo e(asset("publish/dataDirection")); ?>",
