                ...
                <div class="widget-content nopadding">
                    ...
                    <?php foreach($datas as $data): ?>
                        ...
                        <div class="control-group">
                                ...
                                <div class="controls " >
                                    <input type="text" name="AssetType" id="AssetType" value="<?php echo e($data->AssetType); ?>" readonly/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls selectBox" >
                                    ...
                                    <option value="住宅" <?php if($data->Type=="住宅"): ?> selected="selected" <?php endif; ?>>住宅</option>
                                    <option value="商业" <?php if($data->Type=="商业"): ?> selected="selected" <?php endif; ?>>商业</option>
                                    <option value="厂房" <?php if($data->Type=="厂房"): ?> selected="selected" <?php endif; ?>>厂房</option>
                                    <option value="其他" <?php if($data->Type=="其他"): ?> selected="selected" <?php endif; ?>>其他</option>
                                    </select>
                                </div>
                            </div>
                        <div class="control-group">
                            ...
                            <div class="controls selectBox" >
                                ...
                                <option value="工业" <?php if($data->Usefor=="工业"): ?> selected="selected" <?php endif; ?>>工业</option>
                                <option value="商业" <?php if($data->Usefor=="商业"): ?> selected="selected" <?php endif; ?>>商业</option>
                                <option value="住宅" <?php if($data->Usefor=="住宅"): ?> selected="selected" <?php endif; ?>>住宅</option>
                                <option value="其他" <?php if($data->Usefor=="其他"): ?> selected="selected" <?php endif; ?>>其他</option>
                                </select>
                            </div>
                        </div>
                            <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" name="Area" id="Area" value="<?php echo e($data->Area); ?>"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">剩余使用年限</label>
                            <div class="controls">
                                <input type="number" name="Year" id="Year" value="<?php echo e($data->Year); ?>"/>月
                            </div>
                        </div>
                        <div class="control-group">
                                <label class="control-label">转让方式</label>
                                <div class="controls">
                                    <input type="radio" name="TransferType" id="TransferType" value="产权转让" <?php if($data->TransferType=="产权转让"): ?> checked="checked" <?php endif; ?>/>产权转让
                                    <input type="radio" name="TransferType"  id="TransferType" value="股权转让"  <?php if($data->TransferType=="股权转让"): ?> checked="checked" <?php endif; ?> />股权转让
                                </div>
                            </div>
                        <div class="control-group">
                            <label class="control-label">市场价格</label>
                            <div class="controls">
                                <input type="number" name="MarketPrice" id="MarketPrice" value="<?php echo e($data->MarketPrice); ?>"/>万
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">转让价格</label>
                            <div class="controls">
                                <input type="number" name="TransferMoney" id="TransferMoney" value="<?php echo e($data->TransferMoney); ?>"/>万
                            </div>
                        </div>
                        <?php if(!empty($data->Credentials)): ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="radio" name="Credentials" id="Credentials" value="有" <?php if($data->Credentials=="有"): ?> checked="checked" <?php endif; ?>/>有
                                    <input type="radio" name="Credentials"  id="Credentials" value="无"  <?php if($data->Credentials=="无"): ?> checked="checked" <?php endif; ?> />无
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->Dispute)): ?>
                            <div class="control-group">
                                <label class="control-label">法律纠纷</label>
                                <div class="controls">
                                    <input type="radio" name="Dispute" id="Dispute" value="有" <?php if($data->Dispute=="有"): ?> checked="checked" <?php endif; ?>/>有
                                    <input type="radio" name="Dispute"  id="Dispute" value="无"  <?php if($data->Dispute=="无"): ?> checked="checked" <?php endif; ?> />无
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($data->Debt)): ?>
                            <div class="control-group">
                                <label class="control-label">负债</label>
                                <div class="controls">
                                    <input type="radio" name="Debt" id="Debt" value="有" <?php if($data->Debt=="有"): ?> checked="checked" <?php endif; ?>/>有
                                    <input type="radio" name="Debt"  id="Debt" value="无"  <?php if($data->Debt=="无"): ?> checked="checked" <?php endif; ?> />无
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if(!empty($data->Property)): ?>
                            <div class="control-group">
                                <label class="control-label">拥有全部产权</label>
                                    <div class="controls">
                                        <input type="radio" name="Property" id="Property" value="是" <?php if($data->Property=="是"): ?> checked="checked" <?php endif; ?>/>是
                                        <input type="radio" name="Property"  id="Property" value="否"  <?php if($data->Property=="否"): ?> checked="checked" <?php endif; ?> />否
                                    </div>
                            </div>
                        <?php endif; ?>
                        <div class="control-group">
                            ...
                            <div class="controls newsType">
                                <input type="checkbox" name="ProLabel[]" id="ProLabel" value="可议价"   <?php if(in_array("可议价",$proLabels)): ?> checked="checked" <?php endif; ?>/>可议价
                                <input type="checkbox" name="ProLabel[]"  id="ProLabel" value="位置优越"  <?php if(in_array("位置优越",$proLabels)): ?> checked="checked" <?php endif; ?> />位置优越
                                <input type="checkbox" name="ProLabel[]"  id="ProLabel" value="折扣空间大"  <?php if(in_array("折扣空间大",$proLabels)): ?> checked="checked" <?php endif; ?> />折扣空间大
                                <input type="checkbox" name="ProLabel[]"  id="ProLabel" value="有评估报告"  <?php if(in_array("有评估报告",$proLabels)): ?> checked="checked" <?php endif; ?> />有评估报告
                            </div>
                        </div>
                        <div class="control-group">
