...
class Carbon extends DateTime
{
     ...
     * (news Carbon('Monday next week'))->fn()
     *
     * @param string|null              $time
     * @param DateTimeZone|string|null $tz
     *
    ...
    /**
     * Create a news Carbon instance from a specific date and time.
     *
     ...
     *   - When a null (or blank string) is passed to the constructor or parse(), ex. news Carbon(null)
     *   - When the string "now" is passed to the constructor or parse(), ex. news Carbon('now')
     *
