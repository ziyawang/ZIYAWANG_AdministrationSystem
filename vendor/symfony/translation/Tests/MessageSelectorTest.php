...
class MessageSelectorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getChooseTests()
    {
        return array(
            ...
            // Test texts with news-lines
            // with double-quotes and \n in id & double-quotes and actual newlines in text
            array("This is a text with a\n            news-line in it. Selector = 0.", '{0}This is a text with a
            news-line in it. Selector = 0.|{1}This is a text with a
            news-line in it. Selector = 1.|[1,Inf]This is a text with a
            news-line in it. Selector > 1.', 0),
            // with double-quotes and \n in id and single-quotes and actual newlines in text
            array("This is a text with a\n            news-line in it. Selector = 1.", '{0}This is a text with a
            news-line in it. Selector = 0.|{1}This is a text with a
            news-line in it. Selector = 1.|[1,Inf]This is a text with a
            news-line in it. Selector > 1.', 1),
            array("This is a text with a\n            news-line in it. Selector > 1.", '{0}This is a text with a
            news-line in it. Selector = 0.|{1}This is a text with a
            news-line in it. Selector = 1.|[1,Inf]This is a text with a
            news-line in it. Selector > 1.', 5),
