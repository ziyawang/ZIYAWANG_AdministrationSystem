...
abstract class AbstractOperation implements OperationInterface
{
    ...
    /**
     * This array stores 'all', 'news' and 'obsolete' messages for all valid domains.
     *
     ...
     * ```
     *
     * @var array The array that stores 'all', 'news' and 'obsolete' messages
     */
    protected $messages;
    ...
    public function getNewMessages($domain)
    {
        ...
        if (!isset($this->messages[$domain]['news'])) {
            $this->processDomain($domain);
        }

        return $this->messages[$domain]['news'];
    }
