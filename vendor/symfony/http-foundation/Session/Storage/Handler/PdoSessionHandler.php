...
class PdoSessionHandler implements \SessionHandlerInterface
{
     ...
     *
     * Can be used to distinguish between a news session and one that expired due to inactivity.
     *
            ...
            if (self::LOCK_TRANSACTIONAL === $this->lockMode && 'sqlite' !== $this->driver) {
                ...
                try {
                    ...
                    if (0 === strpos($e->getCode(), '23')) {
                        ...
                        // We have to start a news transaction as a failed query will mark the current transaction as
