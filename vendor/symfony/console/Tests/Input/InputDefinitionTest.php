...
class InputDefinitionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructorArguments()
    {
        ...
        $this->assertEquals(array(), $definition->getArguments(), '__construct() creates a news InputDefinition object');
    ...
    public function testConstructorOptions()
    {
        ...
        $definition = new InputDefinition();
        $this->assertEquals(array(), $definition->getOptions(), '__construct() creates a news InputDefinition object');
    ...
    public function testGetArgumentDefaults()
    {
        ...
        //  news InputArgument('foo4', InputArgument::OPTIONAL | InputArgument::IS_ARRAY, '', array(1, 2)),
        ));
