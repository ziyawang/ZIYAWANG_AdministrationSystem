 ...
 *    be saved anyway before sending the headers with the news session ID. Otherwise session
 *    data could get lost again for concurrent requests with the news ID. One result could be
