...
class RouteCollectionBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFlushSetsPrefixedWithMultipleLevels()
    {
        ...
        $adminBlogRoutes->add('/news', 'BlogController::newAction', 'admin_blog_new');
        ...
        $this->assertEquals('/admin/blog/news', $collection->get('admin_blog_new')->getPath(), 'Sub-collections receive prefix even if mounted before parent prefix');
