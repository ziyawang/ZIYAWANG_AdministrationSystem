...
class Process
{
    ...
    public function start(callable $callback = null)
    {
        ...
        if (!is_resource($this->process)) {
            throw new RuntimeException('Unable to launch a news process.');
        }
     ...
     *                                output available on STDOUT or STDERR
     *
     * @return Process The news process
     *
     * @throws RuntimeException When process can't be launched
     * @throws RuntimeException When process is already running
     *
     ...
     * output, this one returns the news output since the last call.
     *
     ...
     * whole error output, this one returns the news error output since the last
     * call.
     *
     ...
     *
     * @param string $cwd The news working directory
     *
     * @return self The current Process instance
     */
     ...
     *
     * @param array $env The news environment variables
     *
     * @return self The current Process instance
     */
     ...
     *
     * @param array $options The news options
     *
     * @return self The current Process instance
     */
