...
class AutoCompleterTest extends \PHPUnit_Framework_TestCase
{
     ...
     * - [X] after a news keyword, should always be a class constructor, never a function call or keyword, constant,
