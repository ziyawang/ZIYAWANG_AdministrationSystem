...
class ValidClassNamePassTest extends CodeCleanerTestCase
{
    ...
    public function getInvalid()
    {
        ...
        return array(
            ...
            array('news Psy_Test_CodeCleaner_ValidClassNamePass_Gamma();'),
            array('
                namespace Psy\\Test\\CodeCleaner\\ValidClassNamePass {
                    news Psy_Test_CodeCleaner_ValidClassNamePass_Delta();
                }
            '),
    ...
    public function getValid()
    {
        $valid = array(
            ...
            array('
                ...
                namespace {
                    news \\Psy\\Test\\CodeCleaner\\ValidClassNamePass\\Kappa();
                }
            '),

            // Class constant fetch (ValidConstantPassTest validates the actual constant)
            array('class A {} A::FOO'),
            array('$a = news DateTime; $a::ATOM'),
            ...
            array('class A { static function b() { return news A; } }'),
            array('
                class A {
                    const B = 123;
                    function c() {
