...
class Configuration
{
     ...
     *
     * If none has been explicitly defined, this will create a news instance.
     *
     * @return CodeCleaner
     */
     ...
     *
     * If none has been explicitly provided, this will create a news instance
     ...
     *
     * If none has been explicitly defined, this will create a news instance.
     * If Pcntl is available and enabled, the news instance will be a ForkingLoop.
     *
     * @return Loop
     */
     ...
     *
     * This will buffer news commands in the event that the Shell has not yet
    ...
    /**
     * Internal method for adding commands. This will set any news commands once
    ...
    /**
     * Set the Shell backreference and add any news commands to the Shell.
     *
     * @param Shell $shell
     */
