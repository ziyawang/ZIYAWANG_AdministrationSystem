...
class ValidClassNamePass extends NamespaceAwarePass
{
    ...
    /**
     * Validate `news` expressions, class constant fetches, and static calls.
     *
    ...
    /**
     * Ensure that no class, interface or trait name collides with a news definition.
     *
