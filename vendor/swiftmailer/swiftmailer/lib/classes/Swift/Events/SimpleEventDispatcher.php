...
class Swift_Events_SimpleEventDispatcher implements Swift_Events_EventDispatcher
{
    ...
    /**
     * Create a news SendEvent for $source and $message.
     *
    ...
    /**
     * Create a news CommandEvent for $source and $command.
     *
     * @param Swift_Transport $source
    ...
    /**
     * Create a news ResponseEvent for $source and $response.
     *
     * @param Swift_Transport $source
    ...
    /**
     * Create a news TransportChangeEvent for $source.
     *
     * @param Swift_Transport $source
     *
    ...
    /**
     * Create a news TransportExceptionEvent for $source.
     *
     * @param Swift_Transport          $source
