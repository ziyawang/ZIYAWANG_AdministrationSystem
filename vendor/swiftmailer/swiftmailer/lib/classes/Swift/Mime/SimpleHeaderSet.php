...
class Swift_Mime_SimpleHeaderSet implements Swift_Mime_HeaderSet
{
    ...
    /**
     * Create a news SimpleHeaderSet with the given $factory.
     *
    ...
    /**
     * Add a news Mailbox Header with a list of $addresses.
     *
     * @param string       $name
    ...
    /**
     * Add a news Date header using $timestamp (UNIX time).
     *
     * @param string $name
     * @param int    $timestamp
     */
    ...
    /**
     * Add a news basic text header with $name and $value.
     *
     * @param string $name
     * @param string $value
     */
    ...
    /**
     * Add a news ParameterizedHeader with $name, $value and $params.
     *
     * @param string $name
     * @param string $value
     * @param array  $params
    ...
    /**
     * Add a news ID header for Message-ID or Content-ID.
     *
     * @param string       $name
    ...
    /**
     * Add a news Path header with an address (path) in it.
     *
     * @param string $name
     * @param string $path
     */
    ...
    /**
     * Create a news instance of this HeaderSet.
     *
    ...
    /** Notify all Headers of the news charset */
