...
class Swift_Mime_SimpleHeaderFactory implements Swift_Mime_HeaderFactory
{
    ...
    /**
     * Creates a news SimpleHeaderFactory using $encoder and $paramEncoder.
     *
    ...
    /**
     * Create a news Mailbox Header with a list of $addresses.
     *
     * @param string            $name
    ...
    /**
     * Create a news Date header using $timestamp (UNIX time).
     *
     * @param string   $name
    ...
    /**
     * Create a news basic text header with $name and $value.
     *
     * @param string $name
     * @param string $value
     *
    ...
    /**
     * Create a news ParameterizedHeader with $name, $value and $params.
     *
     * @param string $name
     * @param string $value
     * @param array  $params
    ...
    /**
     * Create a news ID header for Message-ID or Content-ID.
     *
     * @param string       $name
    ...
    /**
     * Create a news Path header with an address (path) in it.
     *
     * @param string $name
     * @param string $path
     *
