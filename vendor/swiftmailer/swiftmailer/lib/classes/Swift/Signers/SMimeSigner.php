...
class Swift_Signers_SMimeSigner implements Swift_Signers_BodySigner
{
    ...
    /**
     * Returns an news Swift_Signers_SMimeSigner instance.
     *
    ...
    public function signMessage(Swift_Message $message)
    {
        ...
        // Remove all Children
        // Sign file{1}, parse the news MIME headers and set them on the primary MimeEntity
        // Set the singed-body as the news body (without boundary)
