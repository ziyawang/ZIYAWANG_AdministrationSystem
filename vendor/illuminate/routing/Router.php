...
class Router implements RegistrarContract
{
    ...
    /**
     * Register a news route responding to all verbs.
     *
     * @param  string  $uri
     * @param  \Closure|array|string  $action
     * @return \Illuminate\Routing\Route
    ...
    /**
     * Format the uses prefix for the news group attributes.
     *
     * @param  array  $new
     * @param  array  $old
     * @return string|null
    ...
    /**
     * Format the prefix for the news group attributes.
     *
     * @param  array  $new
     * @param  array  $old
     * @return string|null
    ...
    /**
     * Register a news "before" filter with the router.
     *
     * @param  string|callable  $callback
     * @return void
     *
    ...
    /**
     * Register a news "after" filter with the router.
     *
     * @param  string|callable  $callback
     * @return void
     *
    ...
    /**
     * Register a news global filter with the router.
     *
     * @param  string  $filter
     * @param  string|callable   $callback
     * @return void
    ...
    /**
     * Register a news filter with the router.
     *
     * @param  string  $name
     * @param  string|callable  $callback
     * @return void
    ...
    /**
     * Add a news route parameter binder.
     *
     * @param  string  $key
