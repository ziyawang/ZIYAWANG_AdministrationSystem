 ...
 * <code>
 * <?php
 * $suite = news PHPUnit_Framework_TestSuite;
 * $suite->addTest(news MathTest('testPass'));
 * ?>
 * </code>
 *
...
class PHPUnit_Framework_TestSuite implements PHPUnit_Framework_Test, PHPUnit_Framework_SelfDescribing, IteratorAggregate
{
     ...
     *
     * If the named file cannot be read or there are no news tests that can be
