...
class Mailer implements MailerContract, MailQueueContract
{
    ...
    /**
     * Send a news message when only a raw text part.
     *
     * @param  string  $text
    ...
    /**
     * Send a news message when only a plain part.
     *
     * @param  string  $view
     * @param  array  $data
     * @param  mixed  $callback
    ...
    /**
     * Send a news message using a view.
     *
    ...
    /**
     * Queue a news e-mail message for sending.
     *
     * @param  string|array  $view
     * @param  array  $data
     * @param  \Closure|string  $callback
    ...
    /**
     * Queue a news e-mail message for sending on the given queue.
     *
     * @param  string  $queue
     * @param  string|array  $view
     * @param  array  $data
    ...
    /**
     * Queue a news e-mail message for sending after (n) seconds.
     *
     * @param  int  $delay
     * @param  string|array  $view
     * @param  array  $data
    ...
    /**
     * Queue a news e-mail message for sending after (n) seconds on the given queue.
     *
     * @param  string  $queue
     * @param  int  $delay
     * @param  string|array  $view
    ...
    protected function createMessage()
    {
        ...
        // they create a news message. We will just go ahead and push the address.
