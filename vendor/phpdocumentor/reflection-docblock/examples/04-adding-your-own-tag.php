...
final class MyTag extends BaseTag implements StaticMethod
{
    ...
    /**
     * A static Factory that creates a news instance of the current Tag.
     *
     * In this example the MyTag tag can be created by passing a description text as $body. Because we have added
     * a $descriptionFactory that is type-hinted as DescriptionFactory we can now construct a news Description object
