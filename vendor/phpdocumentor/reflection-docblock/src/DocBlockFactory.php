...
final class DocBlockFactory implements DocBlockFactoryInterface
{
    ...
    private function splitDocBlock($comment)
    {
         ...
         * - The long description, any character until a news line is encountered followed by an @ and word
        ...
        preg_match(
            ...
            (?:
              ...
              (
                ...
                (?:
                  ...
                  [\n.] (?! [ \t]* @\pL ) # End summary when an @ is found as first character on a news line
            ...
            (?:
              ...
              (
                [^\n]+
                (?: \n+
                  (?! [ \t]* @\pL ) # End description when an @ is found as first character on a news line
                  [^\n]+            # Include anything else
                )*
              )
            )?
