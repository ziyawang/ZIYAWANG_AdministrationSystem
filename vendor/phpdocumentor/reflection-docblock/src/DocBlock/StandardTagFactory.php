...
final class StandardTagFactory implements TagFactory
{
     ...
     *
     * @see self::registerTagHandler() to add a news tag handler to the existing default list.
     */
    ...
    /**
     * Creates a news tag object with the given name and body or returns null if the tag name was recognized but the
     * body was invalid.
     *
     * @param string  $body
     * @param string  $name
